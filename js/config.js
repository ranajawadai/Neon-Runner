...
// ── Depth Zone Themes (AAA-grade palettes) ──────────────────
export const THEMES = {
  neon: {
    name: 'Neon Abyss', unlock: 0,
    bg: 0x040810, fog: 0x0a1628,
    gridA: 0x00ffcc, gridB: 0x00aaff,
    ground: 0x060c18, groundAccent: 0x0a1430,
    obstacle: 0xff2255, obstacleEmissive: 0xff1144,
    coin: 0x00ffcc, coinEmissive: 0x00ddaa,
    player: 0x00ffcc,
    ambient: 0x0a1a30, ambientIntensity: 0.6,
    lightA: 0x00ffcc, lightB: 0xff2255,
    fogDensity: 0.006,
    star: 0x44ddff,
  },
  synthwave: {
    name: 'Synthwave', unlock: 2000,
    bg: 0x0a0018, fog: 0x1a0040,
    gridA: 0xff00ff, gridB: 0x8800ff,
    ground: 0x080012, groundAccent: 0x100020,
    obstacle: 0xff0066, obstacleEmissive: 0xff0044,
    coin: 0xffcc00, coinEmissive: 0xffaa00,
    player: 0xff00ff,
    ambient: 0x1a0040, ambientIntensity: 0.5,
    lightA: 0xff00ff, lightB: 0xffcc00,
    fogDensity: 0.008,
    star: 0xff44ff,
  },
  cyberpunk: {
    name: 'Cyberpunk', unlock: 5000,
    bg: 0x0a0a0a, fog: 0x1a1a2e,
    gridA: 0x00ffff, gridB: 0xff0088,
    ground: 0x080808, groundAccent: 0x101018,
    obstacle: 0xff0088, obstacleEmissive: 0xdd0066,
    coin: 0x00ffff, coinEmissive: 0x00dddd,
    player: 0x00ffff,
    ambient: 0x1a1a2e, ambientIntensity: 0.45,
    lightA: 0x00ffff, lightB: 0xff0088,
    fogDensity: 0.007,
    star: 0x44ffff,
  },
  aurora: {
    name: 'Aurora', unlock: 10000,
    bg: 0x020810, fog: 0x0a1830,
    gridA: 0x00ff88, gridB: 0x0088ff,
    ground: 0x010408, groundAccent: 0x020c18,
    obstacle: 0xff4488, obstacleEmissive: 0xff2266,
    coin: 0x00ffaa, coinEmissive: 0x00dd88,
    player: 0x00ff88,
    ambient: 0x0a1830, ambientIntensity: 0.4,
    lightA: 0x00ff88, lightB: 0x0088ff,
    fogDensity: 0.009,
    star: 0x88ffcc,
  },
  inferno: {
    name: 'Inferno', unlock: 15000,
    bg: 0x100400, fog: 0x2a0a00,
    gridA: 0xff6600, gridB: 0xffcc00,
    ground: 0x0a0200, groundAccent: 0x140400,
    obstacle: 0xffcc00, obstacleEmissive: 0xffaa00,
    coin: 0xff8800, coinEmissive: 0xff6600,
    player: 0xff6600,
    ambient: 0x2a0a00, ambientIntensity: 0.5,
    lightA: 0xff6600, lightB: 0xffcc00,
    fogDensity: 0.011,
    star: 0xffaa44,
  },
  void: {
    name: 'Void', unlock: 25000,
    bg: 0x000000, fog: 0x050510,
    gridA: 0xaa00ff, gridB: 0xff0066,
    ground: 0x000000, groundAccent: 0x020008,
    obstacle: 0xff0066, obstacleEmissive: 0xdd0044,
    coin: 0xaa00ff, coinEmissive: 0x8800dd,
    player: 0xaa00ff,
    ambient: 0x050510, ambientIntensity: 0.25,
...
export const CHARACTERS = [
  { name: 'Phantom',  shape: 'icosa',  color: 0x00ffcc, unlock: 0 },
  { name: 'Specter',  shape: 'octa',   color: 0xaa00ff, unlock: 1000 },
  { name: 'Nova',     shape: 'dodeca', color: 0xffcc00, unlock: 3000 },
  { name: 'Ember',    shape: 'torus',  color: 0xff0044, unlock: 7000 },
  { name: 'Glitch',   shape: 'icosa',  color: 0xff00ff, unlock: 12000 },
  { name: 'Zero',     shape: 'dodeca', color: 0x00aaff, unlock: 20000 },
];
